            ...
            <div class="col">
                <div class="inbox-rightbar">
                    <div class="btn-group mb-2">
                        ...
                        <a href="{{ route('templatesurat.index') }}" class="btn btn-light" data-bs-toggle="tooltip"
                           data-bs-placement="top" title="" data-bs-original-title="Aktif">
                                            ...
                                            <div class="btn-group">
                                                <form action="{{ route('status',$data->id) }}"
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        <i class="uil uil-envelope-star"></i> Aktifkan
                                                    </button>
                                                </form>
                                            </div>
                                        </td>
